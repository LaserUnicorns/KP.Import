...
using KP.Import.WPApp.Pages.Start;
using KP.Import.WPApp.Services;

// The Blank Application template is documented at http://go.microsoft.com/fwlink/?LinkId=391641

namespace KP.Import.WPApp
{
    /// <summary>
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            builder.RegisterType<AppartmentService>().As<IAppartmentService>();
            builder.RegisterType<ReadingService>().As<IReadingService>();
            builder.RegisterType<StartViewModel>().AsSelf();
            builder.RegisterType<AppartmentViewModel>().AsSelf();
